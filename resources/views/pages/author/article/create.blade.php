                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card mb-4 border-0 lift">
                        <div class="card-header py-3 d-flex flex-wrap justify-content-between align-items-center bg-transparent border-bottom-0">
                            <div>
                                <h6 class="card-title m-0">Tambah Article</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            {{-- start --}}
                            <form class="row g-3" method="POST" action="{{ route('dashboard.article.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor form-control ckeditor @error('isi') is-invalid @enderror" id="editor" name="isi" rows="5"></textarea>
                                    @error('isi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
